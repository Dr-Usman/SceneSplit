...
| --- | --- |
| Account required | No |
| Data stored on our servers | No (expense records stay on device) |
...
- Upload your expense titles, notes, or full ledger to our servers as a cloud sync product
- Access your device contacts, camera, microphone, or location
- Run advertising or behavioral advertising SDKs
...
- All app expense data is stored in a **local database on your device** using SQLite (via the Drift package).
...
On some Android builds, an **INTERNET** permission may be present for font loading and Mixpanel. Your expense database is not uploaded as a cloud backup.
...
Depending on where you live, you may have rights to access, correct, or delete personal information. Because SceneSplit keeps expense data on your device and does not maintain a user account or remote copy of your ledger, you can exercise those rights directly in the app or by uninstalling the app.
